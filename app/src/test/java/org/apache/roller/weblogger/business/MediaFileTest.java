...
public class MediaFileTest {
        ...
        public void setUp() throws Exception {
                ...
                Map<String, RuntimeConfigProperty> config = WebloggerFactory.getWeblogger().getPropertiesManager()
                                .getProperties();
        ...
        public void testSearchMediaFilePaging() throws Exception {
                ...
                try {
                        ...
                        filter3.setOffset(13);
                        filter3.setMaxResults(6);
                        ...
                        filter4.setOffset(14);
                        filter4.setMaxResults(1);
